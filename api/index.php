...
<head>
    ...
    <style>
        ...
        html, body {
            ...
            /* Jangan dikunci total agar pengguna bisa geser layar secara alami saat ngetik */
            overflow-x: hidden; 
        }
        ...
        /* --- AREA KONTEN FORM (BISA DI-SCROLL LONGGAR) --- */
        .konten-form {
            width: 100%;
            display: flex;
            flex-direction: column;
            ...
            box-sizing: border-box;
            flex: 1;
            overflow-y: auto; /* Mengizinkan scroll internal */
            padding-bottom: 100px; /* Jarak aman default dari tombol bawah */
            -webkit-overflow-scrolling: touch;
        }

        /* Sembunyikan garis scrollbar agar desain tetap bersih */
...
<body>
    ...
    <div class="wrapper" id="mainWrapper">
        ...
        <div id="bagian1" class="halaman">
            <div class="konten-form" id="konten1">
                ...
                <input type="text" id="inputNama" placeholder="Masukkan Nama Lengkap" onfocus="fokusMasuk(this)">
                <input type="number" id="inputUmur" placeholder="Masukkan Umur Kamu" onfocus="fokusMasuk(this)">
            </div>
        ...
        <div id="bagian2" class="halaman">
            <div class="konten-form" id="konten2">
                ...
                <input type="text" id="inputHobi" placeholder="Apa Hobi / Cita-citamu?" onfocus="fokusMasuk(this)">
            </div>
            <div class="tombol-container">
    ...
    <script>
        ...
        // --- SISTEM DETEKSI KEYBOARD & DINAMIS PADDING ---
            ...
            window.visualViewport.addEventListener('resize', function() {
                ...
                document.querySelectorAll('.tombol-container').forEach(el => {
                    if (selisihKeyboard > 60) {
                        // 1. Naikkan tombol merah pas di atas keyboard
                        el.style.bottom = selisihKeyboard + 'px';
                        
                        // 2. Berikan padding bawah super longgar pada konten agar form bisa di-scroll ke bawah secara leluasa
                        document.getElementById('konten1').style.paddingBottom = (selisihKeyboard + 40) + 'px';
                        document.getElementById('konten2').style.paddingBottom = (selisihKeyboard + 40) + 'px';
                    } else {
                        el.style.bottom = '0px';
                        document.getElementById('konten1').style.paddingBottom = '100px';
                        document.getElementById('konten2').style.paddingBottom = '100px';
                    }
                });
            });
        }

        // Jalankan fungsi scroll otomatis saat input diklik agar langsung ke tengah area aman
        function fokusMasuk(elemen) {
            setTimeout(function() {
