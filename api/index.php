...
<head>
    ...
    <style>
        ...
        /* --- TRIK SAKTI: KELAS SAAT KEYBOARD AKTIF --- */
        /* Sembunyikan foto kucing agar tulisan deskripsi dapet ruang lega dan turun ke bawah */
        .keyboard-up img {
        ...
        .keyboard-up p {
            ...
            margin-bottom: 15px !important; /* Memberi jarak agar tidak mepet */
            display: block !important; /* Tulisan deskripsi dipaksa tetap kelihatan jelas */
        }
        .keyboard-up input {
...
<body>
    ...
    <script>
        ...
        // --- SISTEM DETEKSI DAN PENYESUAIAN RUANG KEYBOARD CHROME ---
            ...
            window.visualViewport.addEventListener('resize', function() {
                ...
                document.querySelectorAll('.tombol-container').forEach(el => {
                    if (selisihKeyboard > 60) {
                        ...
                        // Picu trik menyembunyikan kucing agar judul dan instruksi turun ke posisi nyaman
                        document.getElementById('konten1').classList.add('keyboard-up');
                        document.getElementById('konten2').classList.add('keyboard-up');
                    } else {
                        el.style.bottom = '0px';
                        // Tampilkan kucing kembali saat keyboard ditutup
