...
<head>
    ...
    <style>
        ...
        html, body {
            ...
            overflow: hidden; /* Mengunci total layar agar bar browser tidak goyang */
        ...
        .halaman {
            ...
            box-sizing: border-box;
            padding: 20px 20px 0 20px; /* Padding bawah 0 karena ada tombol fixed */
            position: relative;
        }
        ...
        /* --- KONTEN FORM ATAS (BISA SCROLL INTERN SAAT KEYBOARD AKTIF) --- */
        .konten-form {
            width: 100%;
            display: flex;
            flex-direction: column;
            align-items: center;
            box-sizing: border-box;
            overflow-y: auto; /* KUNCI UTAMA: Mengizinkan scroll halus jika ruang sempit */
            flex: 1;
            padding-bottom: 90px; /* Ruang aman di bawah agar input tidak ketutup tombol */
        ...
        img {
            ...
            object-fit: cover; 
            margin-top: 15px; 
            display: block; /* Foto kucing dikunci tetap tampil */
        }
        ...
        /* --- CONTAINER TOMBOL MELAYANG PERFECT --- */
        .tombol-container {
            width: 100%;
            max-width: 400px;
            padding: 15px 20px;
...
<body>
    ...
    <div class="wrapper" id="mainWrapper">
        ...
        <div id="bagian1" class="halaman">
            <div class="konten-form" id="konten1">
                ...
                <input type="text" id="inputNama" placeholder="Masukkan Nama Lengkap" onfocus="scrollKeInput(this)">
                <input type="number" id="inputUmur" placeholder="Masukkan Umur Kamu" onfocus="scrollKeInput(this)">
            </div>
        ...
        <div id="bagian2" class="halaman">
            <div class="konten-form" id="konten2">
                ...
                <input type="text" id="inputHobi" placeholder="Apa Hobi / Cita-citamu?" onfocus="scrollKeInput(this)">
            </div>
            <div class="tombol-container">
    ...
    <script>
        ...
        // --- SISTEM DETEKSI KEYBOARD & AKSI SCROLL OTOMATIS ---
            ...
            window.visualViewport.addEventListener('resize', function() {
                ...
                document.querySelectorAll('.tombol-container').forEach(el => {
                    if (selisihKeyboard > 60) {
                        // Tombol ikutan naik tepat di atas keyboard Chrome
        ...
        // Trik khusus agar saat input diklik, halaman bergeser mulus tanpa menutupi teks instruksi
        function scrollKeInput(elemen) {
            setTimeout(function() {
