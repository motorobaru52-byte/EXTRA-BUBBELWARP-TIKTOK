...
<head>
    ...
    <style>
        ...
        .halaman {
            ...
            box-sizing: border-box;
            padding: 15px 20px 75px 20px; /* Padding bawah disiapkan untuk tombol merah */
            position: relative;
        }
        ...
        /* --- KONTEN FORM ATAS (OTOMATIS MENGECIL PROPORSIONAL) --- */
        .konten-form {
            width: 100%;
            display: flex;
            flex-direction: column;
            ...
            box-sizing: border-box;
            flex: 1;
            justify-content: center; /* Membuat konten selalu di tengah ruang yang tersedia */
            min-height: 0; /* Penting agar flexbox bisa menciutkan konten di dalam ruang sempit */
        }
        ...
        img {
            ...
            margin-bottom: 10px;
            object-fit: cover; 
            flex-shrink: 1; /* Mengizinkan foto kucing mengecil fleksibel saat keyboard muncul */
        }
...
<body>
    ...
    <script>
        // Mengatur tinggi container utama agar dinamis mengikuti sisa ruang layar di atas keyboard
        function setSizing() {
        ...
        // --- DETEKSI POSISI TOMBOL DI ATAS KEYBOARD CHROME ---
        if (window.visualViewport) {
