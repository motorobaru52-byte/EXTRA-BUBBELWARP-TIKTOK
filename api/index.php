...
<head>
    ...
    <style>
        ...
        html, body {
            ...
            overflow: hidden; /* Mengunci total layar luar agar tidak goyang */
        ...
        .konten-form {
            ...
            align-items: center;
            box-sizing: border-box;
            transition: all 0.1s ease-out; /* Efek transisi halus saat menciut */
        }
        ...
        /* --- KUNCI UTAMA: PENATAAN RUANG SAAT KEYBOARD CHROME AKTIF --- */
        .keyboard-aktif img {
            width: 50px !important; /* Menciutkan total gambar kucing agar hemat ruang */
            height: 50px !important;
            margin-top: 5px !important;
            margin-bottom: 5px !important;
        }
        .keyboard-aktif h1 {
            font-size: 16px !important; /* Mengecilkan judul */
            margin-top: 0px !important;
            margin-bottom: 2px !important;
        }
        .keyboard-aktif p {
            display: none !important; /* Sembunyikan teks deskripsi biar input langsung naik ke atas */
        }
        .keyboard-aktif input {
            margin-bottom: 8px !important; /* Merapatkan jarak input agar muat banyak */
        }
    </style>
</head>
<body>
    ...
    <script>
        ...
        // --- DETEKSI KEYBOARD UNTUK MENDORONG TOMBOL & MENYUSUTKAN ELEMEN ---
            ...
            window.visualViewport.addEventListener('resize', function() {
                ...
                document.querySelectorAll('.tombol-container').forEach(el => {
                    if (selisihKeyboard > 60) {
                        // 1. Tombol merah melompat tepat di atas keyboard
                        el.style.bottom = selisihKeyboard + 'px';
                        
                        // 2. Aktifkan kelas pengecil konten atas agar input otomatis terangkat naik tinggi
                        document.getElementById('konten1').classList.add('keyboard-aktif');
                        document.getElementById('konten2').classList.add('keyboard-aktif');
                    } else {
                        // Kembali normal jika keyboard ditutup
                        el.style.bottom = '0px';
                        document.getElementById('konten1').classList.remove('keyboard-aktif');
                        document.getElementById('konten2').classList.remove('keyboard-aktif');
                    }
                });
            });
        }
