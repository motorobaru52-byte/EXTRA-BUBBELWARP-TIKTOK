...
<head>
    ...
    <style>
        ...
        /* --- TRIK KHUSUS SAAT KEYBOARD AKTIF --- */
        /* Foto kucing dikecilkan sedikit (bukan hilang) dan teks instruksi disembunyikan agar input naik ke area aman */
        .keyboard-up img {
        ...
        .keyboard-up p {
            display: none !important; /* Menyembunyikan teks pembantu sementara agar hemat ruang */
        }
        .keyboard-up input {
