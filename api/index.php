...
<head>
    ...
    <style>
        ...
        /* --- AREA KONTEN TENGAH (BISA DI-SCROLL BEBAS SAAT MENGETIK) --- */
        .konten-form {
            width: 100%;
            display: flex;
            flex-direction: column;
            ...
            box-sizing: border-box;
            flex: 1;
            /* Rahasia Utama: Mengizinkan halaman digulir atas-bawah secara mandiri */
            overflow-y: auto; 
            padding-bottom: 80px; /* Ruang aman agar input bawah tidak tertutup tombol merah */
            -webkit-overflow-scrolling: touch; 
        }

        /* Menghilangkan garis scrollbar agar tetap terlihat rapi bersih */
        ...
        /* --- CONTAINER TOMBOL FIX MELAYANG DI BAWAH --- */
        .tombol-container {
            width: 100%;
            max-width: 400px;
            padding: 15px 20px;
...
<body>
    ...
    <div class="wrapper" id="mainWrapper">
        ...
        <div id="bagian1" class="halaman">
            <div class="konten-form" id="konten1">
                ...
                <input type="text" id="inputNama" placeholder="Masukkan Nama Lengkap" onfocus="fokusInput(this)">
                <input type="number" id="inputUmur" placeholder="Masukkan Umur Kamu" onfocus="fokusInput(this)">
            </div>
        ...
        <div id="bagian2" class="halaman">
            <div class="konten-form" id="konten2">
                ...
                <input type="text" id="inputHobi" placeholder="Apa Hobi / Cita-citamu?" onfocus="fokusInput(this)">
            </div>
            <div class="tombol-container">
    ...
    <script>
        ...
        // --- DETEKSI KEYBOARD UNTUK TOMBOL MERAH ---
        ...
        // --- SISTEM GULIR OTOMATIS AMAN ---
        function fokusInput(elemen) {
            // Memberi jeda sedikit saat keyboard muncul, lalu geser otomatis agar inputan pas di tengah
            setTimeout(function() {
