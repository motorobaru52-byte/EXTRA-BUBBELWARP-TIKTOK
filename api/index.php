...
<head>
    ...
    <style>
        /* --- KUNCI TOTAL BACKGROUND AGAR TIDAK BISA DI-SCROLL --- */
        html, body {
            height: 100%;
            margin: 0;
            padding: 0;
        ...
        .wrapper {
            ...
            overflow: hidden; /* Kunci pembungkus dalam */
        }
        ...
        .halaman {
            ...
            box-sizing: border-box;
            padding: 10px 20px 75px 20px; /* Jarak pas agar input tidak menempel tombol */
            position: relative;
            overflow: hidden; /* Kunci tiap halaman */
        }
        ...
        .konten-form {
            ...
            overflow: hidden; /* Mematikan scroll internal secara total */
        }
        ...
        img {
            ...
            object-fit: cover; 
            margin-top: 0px; 
            flex-shrink: 0; /* Dikunci agar gambarnya tidak gepeng/mengecil lagi */
        }
...
<body>
    ...
    <script>
        // Set tinggi awal sekali saja agar kokoh tidak naik turun layarnya
        function setSizing() {
        ...
        // --- DETEKSI KEYBOARD UNTUK GERAKAN TOMBOL SAJA (LAYAR UTAMA TETAP DIAM) ---
            ...
            window.visualViewport.addEventListener('resize', function() {
                ...
                document.querySelectorAll('.tombol-container').forEach(el => {
                    if (selisihKeyboard > 60) {
                        // Hanya tombol merah yang melompat ke atas keyboard
