...
<head>
    ...
    <style>
        ...
        .tombol-container {
            ...
            box-sizing: border-box;
            background-color: #f9f9f9; 
            position: absolute; /* Kembali ke absolute agar normal di web */
            bottom: 0;
            left: 50%;
            ...
            z-index: 999;
            transition: bottom 0.1s ease; /* Transisi halus saat terangkat */
        }
        ...
        /* --- KELAS TAMBAHAN SAAT KEYBOARD AKTIF (DIPICU OLEH JAVASCRIPT) --- */
        .keyboard-aktif img {
...
<body>
    ...
    <div class="wrapper" id="mainWrapper">
        ...
        <div id="bagian1" class="halaman">
            <div class="konten-form">
                ...
                <input type="text" id="inputNama" placeholder="Masukkan Nama Lengkap" onfocus="keyboardMuncul()" onblur="keyboardHilang()">
                <input type="number" id="inputUmur" placeholder="Masukkan Umur Kamu" onfocus="keyboardMuncul()" onblur="keyboardHilang()">
            </div>
            <div class="tombol-container" id="tombolBagian1">
        ...
        <div id="bagian2" class="halaman">
            <div class="konten-form">
                ...
                <input type="text" id="inputHobi" placeholder="Apa Hobi / Cita-citamu?" onfocus="keyboardMuncul()" onblur="keyboardHilang()">
            </div>
            <div class="tombol-container" id="tombolBagian2">
    ...
    <script>
        // Menghitung tinggi layar asli browser HP
        ...
        // --- TRIK BARU: JAVASCRIPT UNTUK MEMAKSA TOMBOL NAIK DI INTERNET WEBSITE ---
        function keyboardMuncul() {
            // Tambahkan kelas agar gambar di atas mengecil otomatis
            document.querySelectorAll('.konten-form').forEach(el => el.classList.add('keyboard-aktif'));
            
            // Mengubah posisi tombol menjadi melayang pas di atas keyboard
        ...
        function keyboardHilang() {
            // Kembalikan ke posisi semula saat selesai mengetik
            document.querySelectorAll('.konten-form').forEach(el => el.classList.remove('keyboard-aktif'));
        ...
        function pindahKe(nomorHalaman) {
            keyboardHilang(); // Reset posisi keyboard saat pindah halaman
